...
<div class="row">
   <form action="" class="form-horizontal" enctype="multipart/form-data" action="{{url('attachru/'.$user->id)}}" method="POST">
   @csrf
        <div class="form-group">
            <label for="role_name" class="col-sm-2 control-label">Role Name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="role_name" value="{{$user->name}}" readonly="readonly">
            </div>
        </div>
        <div class="form-group">
