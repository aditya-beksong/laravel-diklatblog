...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Update Berita</h3>
    </div>
    <!-- /.col-lg-12 -->
    <div class="col-sm-12">
...
<div class="row">
    <form action="{{ url('updateberita/'.$data->slug) }}" method="POST" role="form" enctype="multipart/form-data" class="form-horizontal">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="judul" name="judul" value="{{$data->judul}}" required class="form-control">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea name="berita" id="summernote" class="form-control">{{$data->berita}}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <p class="help-block">File Sebelumnya : {{$data->foto}}</p>
            </div>
        </div>
